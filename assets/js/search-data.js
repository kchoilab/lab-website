...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/lab-website/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/lab-website/research/";
          },
        },{id: "nav-publications",
          title: "publications",
          description: "",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/lab-website/software/";
          },
        },{id: "nav-news",
          title: "news",
          description: "",
          content: "K                                                Kiri Choi                                 1월 15일 (편집됨)                                            The CSBLab website is officially live!                          2026년 1월 15일                                                                                        K                                                Kiri Choi                                 1월 15일 (편집됨)                                            Open Positions                          2026년 1월 15일                          We are actively recruiting MS/PhD students with backgrounds in Biology, Physics, CS, Statistics, or Bioengineering.                          Department of Biological Sciences |    Keimyung University                      ▶        ⚙️ Site Map                    People        Research        Publications        Teaching        Software        News        Contact                  Join us        © 2026 Kiri Choi.All rights reserved.",
          section: "Navigation",
          handler: () => {
            window.location.href = "/lab-website/news/";
          },
        },{id: "nav-contact",
          title: "contact",
          description: "",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/lab-website/contact/";
          },
        ...
        handler: () => {
            ...
            window.location.href = "/lab-website/news/2026/TheCSBLabWebsiteIsOfficiallyLive/";
        ...
        handler: () => {
            ...
            window.location.href = "/lab-website/news/2026/OpenPositions/";
