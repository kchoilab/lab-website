...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "People",
          description: "",
          content: "Kiri Choi | Principal Investigator        Kiri Choi is an Assistant Professor of the Department of Biological Sciences at Keimyung University. His research focuses on the intersection of biological structure and dynamic function, spanning from biochemical networks to brain circuits. Before joining Keimyung University, he was awarded Swartz Foundation Fellowship for Theoretical Neuroscience to investigate olfactory coding and odor-guided navigation under the supervision of Thierry Emonet at Yale University. He served as a Research Fellow at KIAS (Korea Institute for Advanced Study) under the supervision of Changbong Hyeon, studying the structural and connective features of the Drosophila olfactory system. He received his Ph.D. in Bioengineering from the University of Washington under the advice of Herbert Sauro, where he worked on the fundamental principle of biochemical reaction networks models. He received his BS in Physics (Biophysics) from the same university.            ✉️Email|            Google Scholar   |           GitHub   |       ResearchGate   |           X/twitter   |      ORCID    Dongheon Lee | Undergraduate Student        Dongheon Lee is an undergraduate researcher in the Department of Biological Sciences. He joined the lab to pursue his interest in neuroscience, specializing in experimental biology using Drosophila models. He is dedicated to mastering practical laboratory skills. His personal interests include growing plants, fishing, and photography.      Gyumin Lee | Undergraduate Student        Gyumin Lee is an undergraduate researcher from the Department of Computer Engineering. Driven by her interest in Bio-AI, she joined the lab to explore the intersection of computing and biology. She is currently focusing on AI-driven research automation to innovate laboratory processes. In her free time, she listens to music to recharge and recover from her academic projects.      Hyunmin Ju   | Undergraduate Student         Hyunmin Ju is an undergraduate researcher in the Department of Biological Sciences. He is passionate about uncovering the fundamental mechanisms of life, with a specific focus on cancer research using Drosophila as a model system. Outside of the lab, he recharges by listening to music, watching movies, and playing RPGs.      Junwoo Shin  | Undergraduate Student        Junwoo Shin is an undergraduate researcher majoring in Mathematics with a minor in Chemistry. Since joining the lab, he has been studying compressed sensing and image reconstruction algorithms. His academic interests also include graph theory. He is a big supporter of Daegu FC and enjoys playing sports, watching games, and taking photographs with his Minolta X-300 film camera.      Jieun Min   | Undergraduate Student        Ji-eun Min is a student in the Department of Biological Sciences. She is interested in combining molecular biology and computational biology to analyze biological phenomena at the molecular level. In her free time, she enjoys listening to music.      Hojeong Shin   | Undergraduate Student        HoJeong Shin is an undergraduate researcher in the Department of Biological Science. Her research interests lie at the intersection of biology and technology, specifically in AI-driven analysis and computational biology. She aims to bridge the gap between biological theory and computational application. In her free time, she stays consistent with her fitness routine.      Hyosang Bae   | Undergraduate Student        Hyosang Bae is an undergraduate researcher and a junior in the Department of Biological Sciences. His research interest lies in experimental biology using Drosophila as a model system, which led him to join the laboratory. Beyond his academic pursuits, he enjoys watching documentaries, gaming, and reading novels. He is currently focusing on gaining hands-on experience in biological experiments and understanding the fundamental mechanisms of life.      Seoyoung Kim   | Undergraduate Student        Seoyoung Kim is an undergraduate student in the Department of Biological Sciences. She is particularly interested in neuroscience and bioinformatics, focusing on understanding how biological systems process and analyze information. In her free time, she enjoys relaxing and recharging to maintain a balanced academic life.      Jinseok Byeon   | Undergraduate Student        Jinseok Byun is an undergraduate researcher from the Department of Statistics. His research interests lie at the intersection of Neuroscience and AI, with a particular focus on olfactory AI. Driven by his core vision of becoming a &#39;Heart Toucher,&#39; he aspires to be a researcher who heals the human body through advanced technology and the human soul through poetry. Outside of his academic pursuits, he finds true happiness in writing poetry :memo: and starting his day with a morning run :runner:      🚀Join UsWe are looking for students with backgrounds in Biology, Physics, Computer Science, Mathematics, Statistics, or Engineering! If you are interested in AI, olfaction, neuroscience, biochemical reaction networks, dynamical systems, or fruit flies 🪰, we want to hear from you.You do not need a background in Biology, but you must be curious about how biological systems work.Please email kirichoi(at)kmu.ac.kr with your CV and a brief statement of interest (1 paragraph).            Department of Biological Sciences |    Keimyung University                      ▶        ⚙️ Site Map                    People        Research        Publications        Teaching        Software        News        Contact                  Join us        © 2026 Kiri Choi.All rights reserved.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Research",
          description: "",
          content: "Our lab combines neuroscience, biophysics, systems biology, and bioinformatics to understand how biological systems process information.      Olfactory Perception &amp;amp; Decision-Making 🪰👃    What shapes our perception of smell?    Navigation is an active process shaped by odor value and context. We investigate the algorithms that allow Drosophila to make informed decisions in complex environments. By combining quantitative behavioral experiments with artificial intelligence, we model how the brain integrates various navigational cues to guide movement. We are particularly interested in how the brain revises the value it assigns to an odor as the environment changes and how that value guides behavior.            Dynamics of Chemosensory Receptors    What principles govern chemical sensing?    We investigate how sensory information is encoded at the molecular interface. We study the dynamics of ligand-receptor binding to understand how olfactory neurons encode strongly fluctuating odor signals. We analyze how receptor kinetics constrain the encoding of context-dependent information. By modeling these interactions, we aim to elucidate the principles of chemical sensing and its effect on downstream neural processing.        Machine Learning for Biological Discovery    Using AI to learn the rules that govern living systems    Modern biology generates data at a scale and dimensionality that outpaces traditional analysis. We apply machine learning to extract interpretable structure from complex biological data. We are particularly interested in applying graph neural networks (GNNs) to predict biological properties from molecular structure. Our applications range from computational olfaction to the design of drug-delivery systems. Using explainable AI, we investigate the principles underlying biological phenomena.            Information Processing in Biological Systems    What makes biological networks robust?    We use the olfactory system as a model to uncover universal principles of biological computation. We aim to understand how network structure shapes function across biological systems at various scales, from neural circuits to biochemical signaling pathways. We investigate the relationship between connectivity and system dynamics to identify topological motifs that support robust information processing.        Computational Methods and Scientific Software    Software as a scientific contribution.    Understanding complex biological systems requires advanced computational tools. We develop methods for analyzing high-dimensional biological data, with a focus on network inference, optimization, and clustering. In particular, we study algorithms that can extract maximum information from sparse experimental data to help guide accurate reconstructions and predictions. We also develop standards-based simulation tools that make biological models easier to reuse and simulation results easier to reproduce.                Department of Biological Sciences |    Keimyung University                      ▶        ⚙️ Site Map                    People        Research        Publications        Teaching        Software        News        Contact                  Join us        © 2026 Kiri Choi.All rights reserved.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Software",
          description: "",
          content: "TelluriumAn integrated Python-based environment for model building, simulation, and analysis. It allows researchers to write human-readable models in Antimony and simulate them instantly using the Python scientific stack. It features first-class support for community standards (SBML, SED-ML, COMBINE).To use:```jsxpip install tellurium```[**[Github]**](https://github.com/sys-bio/tellurium) | [**[Documentation]**](https://tellurium.readthedocs.io/en/latest/)      libRoadRunnerA high-performance SBML simulation engine that uses LLVM JIT compilation to simulate massive biochemical networks in milliseconds. It supports deterministic (ODE), stochastic (Gillespie), and metabolic control analysis (MCA), and can be deployed as a standalone library for large-scale ensemble modeling.To use:```jsxpip install libroadrunner```[**[Github]**](https://github.com/sys-bio/roadrunner) | [**[Documentation]**](https://libroadrunner.readthedocs.io/en/latest/)    metaMEGA meta-modeling algorithm for biochemical reaction networks. It uses evolutionary algorithms to generate model ensembles from perturbation studies, allowing researchers to explore network topology and parameter space effectively to solve inverse problems.[**[Github]**](https://github.com/kirichoi/evoMEG)      phraSED-MLA human-readable simulation setup language. It converts complex, XML-based simulation protocols (SED-ML) into a clean, paraphrased format, allowing users to describe simulation experiments and plotting instructions using simple text.To use:```jsxpip install phrasedml```[**[Github]**](https://github.com/sys-bio/roadrunner)    netplotlibA purely Python-based visualization tool for biochemical reaction networks. Built on NetworkX and Matplotlib, it enables the programmatic generation of publication-quality network diagrams directly from code or model files.To use:```jsxpip install netplotlib```[**[Github]**](https://github.com/kirichoi/netplotlib) | [**[Documentation]**](https://netplotlib.readthedocs.io/en/latest/)---            Department of Biological Sciences |    Keimyung University                      ▶        ⚙️ Site Map                    People        Research        Publications        Teaching        Software        News        Contact                  Join us        © {{ site.time | date: &quot;%Y&quot; }} Kiri Choi.All rights reserved.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Contact",
          description: "",
          content: "Address          Backeun Hall, Room 254-1    Department of Biological Sciences, Keimyung University      1095 Dalgubeol-daero, Dalseo-gu    Daegu 42601, South Korea        백은관 254-1호    계명대학교 생명과학과    대구광역시 달서구 달구벌대로 1095 (우)42601                           Principal InvestigatorKiri ChoiBackeun Hall, Room 252Department of Biological Sciences, Keimyung University1095 Dalgubeol-daero, Dalseo-guDaegu 42601, South Korea백은관 252호계명대학교 생명과학과대구광역시 달서구 달구벌대로 1095 (우)42601✉️ kirichoi(at)kmu.ac.kr☎️ +82 53-580-5537            Department of Biological Sciences |    Keimyung University                      ▶        ⚙️ Site Map                    People        Research        Publications        Teaching        Software        News        Contact                  Join us        © 2026 Kiri Choi.All rights reserved.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
            ...
            window.location.href = "/news/2026/EndofSemester/";
